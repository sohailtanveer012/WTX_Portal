...
import { Home, PieChart, FileText, Settings, Users, FolderOpen, LogOut, User, DollarSign, Book, MessageSquare } from 'lucide-react';
...
export function Sidebar({ activeTab, setActiveTab, isAdmin, setIsAuthenticated, userProfile }: SidebarProps) {
  const userNavItems = [
